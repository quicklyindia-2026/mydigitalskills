      ...
      <header className="header">
        <nav className="container nav" aria-label="Main navigation">
          <Link className="brand" href="/" aria-label="MyDigitalSkills home">
            <img src="/images/mydigitalskills-logo-v3.jpg" alt="MyDigitalSkills - Grow Your Business with us" />
          </Link>
    ...
    <footer className="footer">
      <div className="container footer-grid">
        <div className="footer-brand">
          <img src="/images/mydigitalskills-logo-v3.jpg" alt="MyDigitalSkills" />
