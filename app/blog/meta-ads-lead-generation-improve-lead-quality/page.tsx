...
export default function MetaLeadQualityBlog() {
  return <SiteShell><main><article>
    ...
    <div className="article-shell article-content">
      ...
      <div className="author-box"><img src="/images/lambodar-profile.jpg?v=20260821c" alt="Lambodar Patra" /><div><h3>About Lambodar Patra</h3><p>Meta Ads and digital growth professional with 7+ years of experience managing lead generation and business marketing across multiple industries.</p></div></div>
