  ...
  return (
    <SiteShell><main>
      ...
      <section className="section"><div className="container about-grid">
        <div className="about-photo-clean about-photo-tall"><img src="/images/lambodar-clean-new.png" alt="Lambodar Patra, founder of MyDigitalSkills"/><div className="about-photo-accent">Digital Growth Partner</div></div>
