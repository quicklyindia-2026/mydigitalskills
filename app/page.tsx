      ...
      <main>
        ...
        <section className="section section-soft">
          <div className="container about-grid">
            <div className="about-photo-clean"><img src="/images/lambodar-profile.jpg?v=20260821e" alt="Lambodar Patra"/><div className="about-photo-accent">Strategy → Execution → Growth</div></div>
