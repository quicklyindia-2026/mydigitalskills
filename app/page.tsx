      ...
      <main>
        ...
        <section className="section section-soft">
          <div className="container about-grid">
            <div className="about-photo-clean"><img src="/images/lambodar-clean-new.png" alt="Lambodar Patra"/><div className="about-photo-accent">Strategy → Execution → Growth</div></div>
